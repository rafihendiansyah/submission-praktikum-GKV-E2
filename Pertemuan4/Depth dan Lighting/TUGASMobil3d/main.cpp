...
void Mobil() {
    // Badan mobil
    glPushMatrix();
    glColor3f(0.5f, 0.0f, 0.0f); // Warna merah tua untuk badan mobil
    glTranslatef(0.0f, 0.8f, 0.0f);
    glScalef(6.0f, 1.3f, 2.0f); // Skala ukuran badan mobil
    glutSolidCube(1.0);
    glPopMatrix();
    
    // Cabin
    glPushMatrix();
    glColor3f(0.7f, 0.0f, 0.0f); // Warna merah untuk bagian atas mobil
    glTranslatef(-0.3f, 1.8f, 0.0f);
    glScalef(3.5f, 1.0f, 2.0f); // Skala ukuran bagian atas mobil
    glutSolidCube(1.0);
    glPopMatrix();
    
    // Kaca
    glPushMatrix();
    glColor3f(0.0f, 0.0f, 1.0f); // Warna biru untuk kaca
    glTranslatef(-0.2f, 1.9f, 0.0f);
    glScalef(2.5f, 0.73f, 2.02f); // Skala ukuran kaca mobil
    glutSolidCube(1.0);
    glPopMatrix();
    ...
    // Roda 1
    glPushMatrix();
    glColor3f(0.0f, 0.0f, 0.0f); // Warna hitam untuk roda
    glTranslatef(-2.0f, 0.0f, 1.0f);
    glScalef(2.0f, 2.0f, 2.0f); // Skala ukuran roda
    glutSolidTorus(0.1, 0.2, 10, 10); // Roda mobil berbentuk torus
    glPopMatrix();
